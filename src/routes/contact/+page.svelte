...
<div class="font-display antialiased text-slate-900 bg-bg-main min-h-screen flex flex-col selection:bg-primary/10">
    ...
    <main class="flex-grow pt-24">
        ...
        <section class="relative py-24 overflow-hidden border-b border-slate-100">
            <div class="absolute inset-0 bg-[radial-gradient(40%_40%_at_50%_0%,rgba(29,78,216,0.02)_0%,transparent_100%)]"></div>
            <div class="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 text-center">
                <h1 class="text-5xl md:text-6xl font-black tracking-tight text-slate-900 mb-6 leading-none">Global Comms Node.</h1>
                <p class="mx-auto max-w-2xl text-lg text-slate-500 font-medium">
                    Initialize a direct priority line with our institutional support protocols.
                </p>
            </div>
        </section>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div class="lg:col-span-5 space-y-12">
                        <div class="space-y-6">
                            <h2 class="text-3xl font-black text-slate-900 tracking-tight">Technical Headquarters</h2>
                            <p class="text-slate-500 font-medium leading-relaxed">Our clinical support engineers are on standby for complex operational resolution.</p>
                        </div>

                        <div class="grid grid-cols-1 gap-8">
                            {#each [
                                { icon: 'alternate_email', label: 'Network Inquiries', val: 'ops@logipro.global' },
                                { icon: 'perm_phone_msg', label: 'Institutional Line', val: '+1 (800) LOGI-PRO' },
                                { icon: 'location_on', label: 'Physical Terminal', val: 'Logistics Gate 01, Silicon Valley, CA' }
                            ] as item}
                        ...
                        <div class="premium-card p-10 md:p-16 relative overflow-hidden">
                            {#if isSent}
                                <div class="py-20 text-center animate-fade-in">
                                    ...
                                    <h3 class="text-3xl font-black text-slate-900 mb-4 tracking-tight">Transmission Verified</h3>
                                    <p class="text-slate-500 font-medium">Your request has been prioritized in our global queue.</p>
                                </div>
                            {:else}
                                <form onsubmit={handleSubmit} class="space-y-8">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div class="space-y-2">
                                            <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Identity Tag</span>
                                        ...
                                        <div class="space-y-2">
                                            <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Comms Protocol</span>
                                    ...
                                    <div class="space-y-2">
                                        <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Inquiry Payload</span>
                                        <textarea bind:value={message} required rows="5" placeholder="Detail your operational requirements..." class="w-full px-5 py-4 rounded-2xl bg-slate-50 border-none text-sm font-bold focus:bg-white focus:ring-2 focus:ring-primary/20 transition-all shadow-inner resize-none"></textarea>
                                    </div>
