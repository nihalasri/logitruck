            ...
            <div class="hidden lg:flex flex-1 max-w-xl">
                <div class="relative w-full group">
                    ...
                    <input 
                        ...
                        placeholder="Search assets, loads or drivers..." 
                        type="text"
                    />
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="flex flex-col">
                    <div class="flex items-center gap-3">
                        <h2 class="text-4xl font-black text-slate-900 tracking-tight leading-none font-display">Operational Overview</h2>
                    ...
                    <div class="flex items-center gap-4 mt-2">
                        <p class="text-text-muted font-medium">Tuesday, January 2nd • System Health: <span class="text-emerald-500 font-bold">Optimal</span></p>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="xl:col-span-2 flex flex-col gap-8">
                    <div class="premium-card overflow-hidden flex flex-col">
                        <div class="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/30">
                            <h3 class="font-black text-xl text-slate-900 tracking-tight">Real-time Logistics</h3>
                        ...
                        <div class="overflow-x-auto px-2">
                            <table class="w-full text-left text-sm">
                                <thead class="text-slate-400 uppercase font-black text-[10px] tracking-widest">
                                    <tr>
                                        <th class="px-6 py-5">Asset Descriptor</th>
                                        <th class="px-6 py-5">Trajectory</th>
                                        <th class="px-6 py-5 text-center">Status Matrix</th>
                                        <th class="px-6 py-5 text-right">Performance</th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr class="group hover:bg-slate-50/80 transition-all cursor-pointer">
                                        <td class="px-6 py-5">
                                            <div class="flex flex-col">
                                                ...
                                                <span class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Verified Node</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-5">
                                            <div class="flex items-center gap-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pb-8">
                        <div class="premium-card p-8 group overflow-hidden relative min-h-[280px]">
                            ...
                            <div class="relative z-10 h-full flex flex-col justify-between">
                                <div>
                                    <h3 class="text-2xl font-black tracking-tight mb-2">Carrier Network</h3>
                        ...
                        <div class="premium-card p-8 bg-primary text-white overflow-hidden relative shadow-2xl shadow-primary/20">
                            ...
                            <div class="relative z-10 flex flex-col h-full justify-between">
                                <div>
                                    <h3 class="text-2xl font-black tracking-tight mb-2">Cargo Shield™</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="p-6 rounded-3xl bg-emerald-50 border border-emerald-100 flex flex-col gap-4 group cursor-pointer hover:bg-emerald-100/50 transition-all">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] font-bold text-emerald-600 uppercase tracking-widest mt-1">Direct Node Connection</p>
                            </div>
                        </div>
                        <div class="p-6 rounded-3xl bg-indigo-50 border border-indigo-100 flex flex-col gap-4 group cursor-pointer hover:bg-indigo-100/50 transition-all">
                            ...
                            <div>
                                <h4 class="font-black text-slate-900">Enterprise API</h4>
                                <p class="text-[10px] font-bold text-indigo-600 uppercase tracking-widest mt-1">SME Integration Port</p>
                            </div>
                        </div>
                        <div class="p-6 rounded-3xl bg-slate-900 text-white flex flex-col gap-4 group cursor-pointer hover:bg-slate-800 transition-all">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Data Stream Link</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    <div class="premium-card flex flex-col h-fit">
                        <div class="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/30">
                            <h3 class="font-black text-lg tracking-tight">Active Offers</h3>
                    ...
                    <div class="premium-card p-8 bg-gradient-to-br from-primary to-indigo-700 text-white relative overflow-hidden group shadow-2xl shadow-primary/30">
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-blue-100 text-sm font-medium mb-8 leading-relaxed">Invite a business node to our network and receive <span class="font-black text-white">$50 Shipping Credits</span>.</p>
